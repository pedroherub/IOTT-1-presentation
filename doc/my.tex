...
\subsection{第 5 小节 Issues}
    ...
    \begin{frame}
        ...
        \begin{codeblock}[language=bash]{Shell代码}
sudo rmmod ch341        
        \end{codeblock}

%         \begin{codeblock}[language=shell]{Shell代码}
% wget https://www.dropbox.com/s/u8ny4lvyxeh8v5u/serial.tar.gz
% tar -zxvf serial.tar.gz \&& cd serial
